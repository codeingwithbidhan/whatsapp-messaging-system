...
class SocketService {
    constructor() {
        ...
        /**
        * Agora ক্লায়েন্ট ইনিশিয়ালাইজ করে এবং রিমোট ইভেন্ট হ্যান্ডলার সেট আপ করে।
        * এই ফাংশনটি অ্যাপ্লিকেশন লোডের সময় একবার কল করা আবশ্যক।
        */
    
        // App.jsx initAgoraClient ai function call kora hoyche.
        initAgoraClient() {
            if (agoraClient) {
            ...
            // উদাহরণস্বরূপ ইভেন্ট লিসেনার (আপনার প্রয়োজন অনুযায়ী Redux/Socket ডিসপ্যাচ যুক্ত করুন)
            agoraClient.on("user-published", this.handleUserPublished);
            agoraClient.on("user-unpublished", this.handleUserUnpublished);
            agoraClient.on("user-joined", this.handleUserJoined);
            agoraClient.on("user-left", this.handleUserLeft);
            
            console.log("Agora client initialized.");
            // agoraClient.on("network-quality", (stats) => {
            //     console.log("Network quality: download=" + stats.downlinkNetworkQuality + ", upload=" + stats.uplinkNetworkQuality);
            // });
            return agoraClient;
            ...
            //     // 1. রিমোট ইউজার যখন ট্র্যাক পাবলিশ করে
            //     agoraClient.on('user-published', async (user, mediaType) => {
            //         await agoraClient.subscribe(user, mediaType);
                    
            //         // কম্পোনেন্টকে জানানোর জন্য Redux-এ ডিসপ্যাচ
            //         // (যদি আপনার UI রেন্ডারিং-এর জন্য অন্য কোনো স্টেট লাগে)
            //         // আপাতত আমরা সরাসরি Redux-এ remoteStream সেট করছি।
    
            //         if (mediaType === 'video') {
            //             // রিমোট ভিডিও ট্র্যাক Redux-এ সেট করা
            ...
            //         console.log(`User ${user.uid} published ${mediaType}. Subscribed.`);
            //     });
    
            //     // 2. রিমোট ইউজার যখন আনপাবলিশ করে বা মিউট করে
            //     agoraClient.on('user-unpublished', (user, mediaType) => {
            //         console.log(`User ${user.uid} unpublished ${mediaType}`);
            //         // যদি ভিডিও আনপাবলিশ করে, তবে Redux থেকে রিমোট ভিডিও ট্র্যাক সরিয়ে দিন
            //         if (mediaType === 'video') {
            //              // store.dispatch(removeRemoteVideoTrack(user.uid)); // এই অ্যাকশনটি প্রয়োজন হতে পারে
            //         }
            //     });
    
            //     // 3. রিমোট ইউজার যখন কল ছেড়ে চলে যায়
            //     agoraClient.on('user-left', (user) => {
            //         console.log("Remote user left:", user.uid);
            //         delete remoteUsers[user.uid];
                    
            //         // কলটি শেষ করার জন্য Redux-এ ডিসপ্যাচ করা
            //         store.dispatch(resetCallState()); 
            //         toast.error("Call ended by the other party.");
            //     });
                
            //     // 4. নেটওয়ার্ক কোয়ালিটি মনিটর করা
            //     agoraClient.on("network-quality", (stats) => {
            //         console.log("Network quality: download=" + stats.downlinkNetworkQuality + ", upload=" + stats.uplinkNetworkQuality);
            //     });
            // }
